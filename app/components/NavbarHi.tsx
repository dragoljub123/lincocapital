    ...
    <div className="fixed mx-auto w-full h-12 sm:h-16 z-50 bg-transparent">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between px-5 md:px-10 lg:px-10 xl:px-10 h-full">
        ...
        <div className="fixed right-0 px-4 lg:hidden">
          <button
            onClick={toggleLinks}
            className="text-tirkizna text-2xl focus:outline-none"
          >
            <FiMenu />
          </button>

          {showLinks && (
            <div className="fixed top-0 left-0 w-full h-fitbg-transparent backdrop-blur-3xl p-4 shadow-lg transition-transform transform translate-x-0 z-50">
